...
r = s.post(
    os.environ.get("APP_BASE_URL", "https://hudhud-radar.vercel.app") + "/auth/login",
    json={"email": "karim@ebdamarketing.com", "password": "Hudhud2026!Secure"},
)
print("login:", r.status_code)
r2 = s.get(os.environ.get("APP_BASE_URL", "https://hudhud-radar.vercel.app") + "/api/debug/secrets-check")
