"""
Custom Exception Classes for HudhudRadar.
"""


class HudhudRadarException(Exception):
    """Base exception for all HudhudRadar errors."""
...
class MetaAPIError(HudhudRadarException):
...
class RateLimitExceededError(HudhudRadarException):
...
class MessagingWindowExpiredError(HudhudRadarException):
