"""
Configuration and Environment Settings for SocailManager.
"""
...
class Settings(BaseSettings):
    ...
    META_WEBHOOK_VERIFY_TOKEN: str = Field(default="socailmanager-verify-token-secret", description="Webhook verify token")
